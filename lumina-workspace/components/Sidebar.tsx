...
const NavItem: React.FC<NavItemProps> = ({
  ...
  <div
    onClick={onClick}
    className={`flex items-center gap-2 px-3 py-1.5 rounded cursor-pointer group text-sm transition-colors ${active
  ...
  return (
    <aside className="w-64 h-screen bg-[#f7f6f3] dark:bg-[#1f1f1f] border-r border-[#ececeb] dark:border-[#373737] flex flex-col select-none relative group/sidebar">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-2 space-y-1">
        ...
        <NavItem icon={<ICONS.Page />} label="Templates" onClick={onOpenTemplates} />
